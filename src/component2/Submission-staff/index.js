...
const Submission = () => {
    ...
    const incNum = () => {
        alert("Your Music is selected");
        setNum(num + 1)
    }
    const decNum = () => {
        if (num > 0) {
            alert("Your Music is rejected");
            setNum(num - 1)
        } else {
        ...
        <SubmissionStyle>
            <SubPage>
                ...
                <div className="Submission-page">
                        ...
                        <div className="art-desc desc">
                            <div className="art-desc-heading">
                                ...
                                <div className="sign">
                                    ...
                                    <div className="sigb"><Link onClick={incNum} className="sigc" to="#"><FiCheck /></Link></div>
                                    <div className="sigb"><Link onClick={decNum} className="sigc" to="#"><FiX /></Link></div>
                                </div>
                            </div>
                            <div className="types">
                                <div className="Title">
                    ...
                    <div className="music">
                        <h3>Music</h3>
                        <p className="gc">{num} Music Submissions yet.</p>
                    </div>
                </div>
