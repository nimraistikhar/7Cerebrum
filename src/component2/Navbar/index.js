                    ...
                    <div className={toggle ? `shown` : `hidden`}>
                        <nav className="navigation-nav">
                            <ul className="list">
                               ...
                               <li className="gcb item"><NavLink className="gc NavLink" exact to="/SubmissionStaff">All Submissions</NavLink></li>
                               <li className="gcb item"><NavLink className="gc NavLink" to="/dashboard">Dashboard Dashboard</NavLink></li>
                               <li className="gcb gc item simply">Account</li>
                               <li className="gcb gc item simply">Team</li>
                               <Theming />
                               <li className="gcb item"><NavLink className="gc NavLink" to="/logoutHome">Logout</NavLink></li>
                            </ul>
                            <ul className="icon">
