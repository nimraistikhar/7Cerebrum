            ...
            <StyledNav className="nav" role="navigation">
                <div className="main-nav">
                    ...
                    <ul className={toggle ? "toggle" : ""}>
                        ...
                        <li className="li"><NavLink className="gc" exact to="/logoutHome">Home</NavLink></li>
                        ...
                        <li className="li"><NavLink className="gc" exact to="contactLogOut">Contact us</NavLink></li>
                        <Theming />
                    </ul>
